...
export const ReportPage: React.FC = () => {
 ...
 return (
 <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in- duration-500">
 ...
 <div className="bg-white dark:bg-[#242424] p-4 rounded-lg shadow-sm border border-border-color dark:border-border-color flex flex-col md:flex-row gap-4 print:hidden">
 <div className="flex-1 flex items-center gap-2">
 <Filter size={18} className="text-slate-400" />
 <select 
 value={reportType}
 onChange={(e) => setReportType(e.target.value as any)}
 className="flex-1 bg-slate-50 dark:bg-[#1A1A1A]/50 border border-border-color dark:border-border-color rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary text-sm text-slate-800 dark:text-slate-200 font-medium"
 >
 ...
 {/* Report Preview */}
 <div className="bg-white dark:bg-[#242424] rounded-lg shadow-sm border border-border-color dark:border-border-color overflow-hidden print:shadow-none print:border-none">
 <div className="p-6 border-b border-slate-100 dark:border-border-color/50 flex justify-between items-center print:border-b-2 print:border-slate-800">
 <div>
 ...
 <thead>
 <tr className="bg-slate-50 dark:bg-[#1A1A1A]/50 border-b border-border-color dark:border-border-color text-sm font-semibold text-slate-600 dark:text-slate-300">
 ...
 task.status === 'in_progress' ? 'bg-subtle text-primary dark:bg-blue-900/30 dark:text-primary' :
 ...
 size="xs" 
 title={u.name} 
 className="w-6 h-6 border-2 border-white dark:border-border-color z-10" 
 />
 );
 })}
