...
export const AnalyticsPage: React.FC = () => {
 ...
 <div className="flex items-center gap-2 bg-white dark:bg-[#242424] p-2 rounded-lg shadow-sm border border-border-color dark:border-border-color">
 ...
 {/* Status Distribution */}
 <div className="bg-white dark:bg-[#242424] rounded-lg shadow-sm border border-border-color dark:border-border-color p-6">
 ...
 {/* Completion Trend */}
 <div className="bg-white dark:bg-[#242424] rounded-lg shadow-sm border border-border-color dark:border-border-color p-6 md:col-span-2 lg:col-span-1">
 <div className="flex items-center gap-2 mb-6">
