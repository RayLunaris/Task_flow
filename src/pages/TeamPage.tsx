...
export const TeamPage: React.FC = () => {
 ...
 return (
 <div className="space-y-6 animate-in fade-in slide-in- duration-500 pb-16">
 {/* Top Header */}
 ...
 {/* Main Tab Navigation */}
 <div className="flex items-center justify-between border-b border-border-color dark:border-border-color pt-2 overflow-x-auto">
 ...
 <div className="text-center py-16 bg-white dark:bg-[#1A1A1A] rounded-lg border border-border-color dark:border-border-color text-slate-500">
