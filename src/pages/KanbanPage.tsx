        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full sm:w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl py-2.5 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary font-medium text-slate-800 dark:text-slate-100 appearance-none shadow-sm"
            >
