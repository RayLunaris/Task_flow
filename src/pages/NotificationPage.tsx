...
export const NotificationPage: React.FC = () => {
 ...
 <button
 onClick={handleBack}
 className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-lg border border-border-color dark:border-border-color bg-white dark:bg-[#1A1A1A] text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary hover:border-primary/40 dark:hover:border-primary/40 shadow-sm transition-all cursor-pointer group"
 title={t('common.back')}
 >
 ...
 <div className="bg-white dark:bg-[#1A1A1A] rounded-lg shadow-sm border border-border-color dark:border-border-color overflow-hidden">
 {notifications.length === 0 ? (
 <div className="p-12 text-center text-slate-500 dark:text-slate-400">
 <div className="w-20 h-20 bg-slate-50 dark:bg-[#242424] rounded-full flex items-center justify-center mx-auto mb-4">
