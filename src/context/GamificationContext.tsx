...
export const GamificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
 ...
 addBadge({ id: 'streak-7', name: 'Streak 7 Hari', description: 'Aktif 7 hari berturut-turut', icon: 'flame', unlockedAt: new Date().toISOString() });
 }
 ...
 addBadge({ id: 'kilat', name: 'Kilat', description: 'Menyelesaikan 5 tugas dalam 1 hari', icon: 'zap', unlockedAt: new Date().toISOString() });
 }
 ...
 addBadge({ id: 'tepat-waktu', name: 'Tepat Waktu', description: '10 tugas selesai sebelum deadline', icon: 'target', unlockedAt: new Date().toISOString() });
 }
 ...
 addBadge({ id: 'sempurna', name: 'Sempurna', description: 'Menyelesaikan 20 tugas total', icon: 'trophy', unlockedAt: new Date().toISOString() });
 }
