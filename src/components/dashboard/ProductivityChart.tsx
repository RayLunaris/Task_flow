...
export const ProductivityChart: React.FC = () => {
 ...
 const stats = [
 { label: 'Total Tasks', value: totalTasks, icon: LayoutList, color: 'text-slate-700 dark:text-slate-300', bg: 'bg-slate-100 dark:bg-[#242424]' },
 ...
 whileHover={{ y: -2 }}
 className="bg-white dark:bg-[#1A1A1A] p-5 rounded-lg border border-border-color dark:border-border-color shadow-sm transition-all flex flex-col justify-between"
 >
 ...
 <motion.div variants={itemVariants} className="bg-white dark:bg-[#1A1A1A] p-6 rounded-lg border border-border-color dark:border-border-color shadow-sm">
 <div className="flex items-center justify-between mb-8">
 <h3 className="text-base font-semibold tracking-tight text-slate-900 dark:text-slate-50">
 Task Activity (Last 7 Days)
 </h3>
 <div className="text-xs font-medium bg-slate-50 dark:bg-[#242424] border border-border-color dark:border-border-color text-slate-600 dark:text-slate-300 px-3 py-1 rounded-full">
 Completed
 </div>
 </div>
