...
export const TaskFilterBar: React.FC = () => {
 ...
 ? 'bg-[#E3F2FD] dark:bg-blue-900/30 text-[#0D47A1] dark:text-primary border-[#90CAF9] dark:border-blue-800'
 : 'bg-white dark:bg-[#1A1A1A] text-slate-600 dark:text-slate-400 border-border-color dark:border-border-color hover:bg-slate-50 dark:hover:bg-slate-800'
 )}
 >
 <Filter size={16} />
 ...
 {isOpen && (
 <div className="bg-white dark:bg-[#1A1A1A] p-4 rounded-lg border border-border-color dark:border-border-color shadow-sm animate-in fade-in slide-in- flex flex-col md:flex-row gap-4 transition-colors duration-300">
 ...
 className="text-sm border border-border-color dark:border-border-color rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary bg-slate-50 dark:bg-[#242424] text-slate-700 dark:text-slate-300 font-medium"
 >
 ...
 <div className="w-px bg-slate-100 dark:bg-[#242424] hidden md:block"></div>
 ...
 className="flex items-center gap-2 px-3 py-2 border border-border-color dark:border-border-color rounded-lg text-sm font-medium bg-slate-50 dark:bg-[#242424] text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
