...
export const RoleMatrixModal: React.FC<RoleMatrixModalProps> = ({ isOpen, onClose }) => {
 ...
 if (val === false) {
 return (
 <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-slate-100 dark:bg-[#242424] text-slate-400">
 <Minus size={14} strokeWidth={2} />
 </span>
 );
 }
 return (
 <span className="text-[11px] font-semibold px-2 py-0.5 rounded-full bg-subtle dark:bg-blue-950/40 text-primary dark:text-primary border border-blue-200/60 dark:border-blue-800/40">
 {val}
 </span>
 );
 };
 ...
 className="relative w-[92%] sm:w-full max-w-4xl bg-white dark:bg-[#1A1A1A] rounded-lg shadow-sm overflow-hidden border border-border-color dark:border-border-color flex flex-col max-h-[85vh]"
 >
 {/* Modal Header */}
 <div className="flex items-center justify-between p-5 border-b border-slate-100 dark:border-border-color">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-lg bg-subtle dark:bg-blue-900/40 text-primary flex items-center justify-center">
 <ShieldCheck size={22} />
 </div>
 <div>
 ...
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-slate-50 dark:bg-[#242424]/40 border-b border-slate-100 dark:border-border-color text-xs">
 <div className="p-3 bg-white dark:bg-[#1A1A1A] rounded-lg border border-pink-200/70 dark:border-pink-900/40">
 ...
 <div className="p-3 bg-white dark:bg-[#1A1A1A] rounded-lg border border-blue-200/70 dark:border-blue-900/40">
 <span className="font-bold text-primary dark:text-primary uppercase text-[10px] tracking-wider block mb-1">
 Project Manager
 </span>
 <p className="text-slate-600 dark:text-slate-400">Membuat task, membagi beban kerja, milestone, dan review approval.</p>
 </div>
 <div className="p-3 bg-white dark:bg-[#1A1A1A] rounded-lg border border-teal-200/70 dark:border-teal-900/40">
 ...
 <div className="p-3 bg-white dark:bg-[#1A1A1A] rounded-lg border border-purple-200/70 dark:border-purple-900/40">
 <span className="font-bold text-primary dark:text-purple-400 uppercase text-[10px] tracking-wider block mb-1">
 Client / Viewer
 </span>
 ...
 <thead>
 <tr className="border-b border-border-color dark:border-border-color text-xs font-bold text-slate-500 uppercase tracking-wider">
 <th className="pb-3 pl-2">Hak Akses / Wewenang</th>
 <th className="pb-3 text-center w-28 text-pink-600 dark:text-pink-400">Admin</th>
 <th className="pb-3 text-center w-28 text-primary dark:text-primary">Manager</th>
 <th className="pb-3 text-center w-28 text-teal-600 dark:text-teal-400">Member</th>
 <th className="pb-3 text-center w-32 text-primary dark:text-purple-400">Client / Viewer</th>
 </tr>
 </thead>
 ...
 {/* Footer */}
 <div className="p-4 border-t border-slate-100 dark:border-border-color flex items-center justify-between bg-slate-50/50 dark:bg-[#1A1A1A]/50">
