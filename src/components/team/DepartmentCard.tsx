...
export const DepartmentCard: React.FC<DepartmentCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={clsx(
        "group cursor-pointer rounded-2xl p-5 border bg-white dark:bg-slate-900 transition-all duration-300 shadow-sm hover:shadow-xl flex flex-col justify-between relative overflow-hidden",
        styles.border
      )}
    >
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-3.5">
          <div className={clsx(
            "w-12 h-12 rounded-xl flex items-center justify-center shadow-xs transition-transform group-hover:scale-105",
            styles.bg,
            styles.text
          )}>
        ...
        {leadUser && (
          <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800/80 mb-4">
      ...
      <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center -space-x-2 overflow-hidden py-0.5">
            ...
            {members.length > 4 && (
              <div className="w-7 h-7 rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-bold text-[10px] flex items-center justify-center ring-2 ring-white dark:ring-slate-900">
                +{members.length - 4}
              </div>
            )}
            {members.length === 0 && (
          ...
          <div className="flex items-center gap-2 text-xs font-semibold">
            <span className="text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded-md flex items-center gap-1">
