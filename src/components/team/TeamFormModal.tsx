...
export const TeamFormModal: React.FC<TeamFormModalProps> = ({ isOpen, onClose, memberToEdit, initialDepartment }) => {
 ...
 className="relative w-[92%] sm:w-full max-w-lg bg-white dark:bg-[#1A1A1A] rounded-lg shadow-sm overflow-hidden border border-border-color dark:border-border-color"
 >
 {/* Header */}
 ...
 <div className="flex border-b border-slate-100 dark:border-border-color bg-slate-50 dark:bg-[#242424]/40 p-1 m-4 mb-0 rounded-lg">
 <button
 type="button"
 ...
 activeTab === 'existing'
 ? 'bg-white dark:bg-[#1A1A1A] text-primary shadow-xs'
 ...
 <div className="p-3 bg-slate-50 dark:bg-[#242424]/60 rounded-lg border border-border-color dark:border-border-color text-left space-y-2">
 ...
 className="flex-1 bg-white dark:bg-[#1A1A1A] border border-border-color dark:border-border-color rounded-lg py-1.5 px-2.5 text-xs text-slate-600 dark:text-slate-300 select-all font-mono"
 />
 ...
 className="w-full text-sm border border-border-color dark:border-border-color rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-primary/40 bg-white dark:bg-[#242424] text-slate-700 dark:text-slate-200 font-semibold"
 >
