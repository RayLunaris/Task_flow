...
export const TeamStatsSummary: React.FC = () => {
 ...
 {/* Total Team */}
 <div className="bg-white dark:bg-[#1A1A1A] p-4 rounded-lg border border-border-color dark:border-border-color shadow-sm flex items-center gap-3.5">
 <div className="w-12 h-12 rounded-lg bg-subtle dark:bg-blue-900/30 text-primary flex items-center justify-center flex-shrink-0">
 <Users size={24} />
 </div>
 <div>
 ...
 {/* Active Members */}
 <div className="bg-white dark:bg-[#1A1A1A] p-4 rounded-lg border border-border-color dark:border-border-color shadow-sm flex items-center gap-3.5">
 <div className="w-12 h-12 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center flex-shrink-0">
 <UserCheck size={24} />
 </div>
 <div>
 ...
 {/* Pending Invites */}
 <div className="bg-white dark:bg-[#1A1A1A] p-4 rounded-lg border border-border-color dark:border-border-color shadow-sm flex items-center gap-3.5">
 <div className="w-12 h-12 rounded-lg bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 flex items-center justify-center flex-shrink-0">
 <Clock size={24} />
 </div>
 <div>
