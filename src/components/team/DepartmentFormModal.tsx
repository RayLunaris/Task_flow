          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-2.5 focus:outline-none focus:ring-2 focus:ring-primary/40 text-slate-800 dark:text-slate-100 resize-none"
              />
            </div>
