...
export const DepartmentDetailView: React.FC<DepartmentDetailViewProps> = ({
 ...
 <button
 onClick={onBack}
 className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg bg-white dark:bg-[#1A1A1A] border border-border-color dark:border-border-color text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200 hover:text-primary hover:border-primary/50 shadow-xs transition-all cursor-pointer group"
 >
 ...
 className={clsx(
 "rounded-lg p-6 sm:p-7 border bg-white dark:bg-[#1A1A1A] shadow-sm relative overflow-hidden",
 styles.border
 )}
 >
 {/* Accent strip */}
 ...
 <div className={clsx(
 "w-16 h-16 rounded-lg flex items-center justify-center shadow-md flex-shrink-0",
 styles.bg,
 styles.text
 )}>
 ...
 <div className="p-3 bg-slate-50 dark:bg-[#242424]/60 rounded-lg border border-slate-100 dark:border-border-color text-center">
 ...
 <div className="p-3 bg-subtle/60 dark:bg-blue-950/30 rounded-lg border border-blue-100 dark:border-blue-900/40 text-center">
 <p className="text-[10px] font-bold text-primary uppercase tracking-wider">Tugas Aktif</p>
 <p className="text-lg font-black text-primary dark:text-primary mt-0.5">{activeTasks.length}</p>
 </div>
 <div className="p-3 bg-emerald-50/60 dark:bg-emerald-950/30 rounded-lg border border-emerald-100 dark:border-emerald-900/40 text-center">
 ...
 className="w-full bg-white dark:bg-[#1A1A1A] border border-border-color dark:border-border-color rounded-lg py-2.5 pl-9 pr-4 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 text-slate-800 dark:text-slate-100 shadow-xs"
 />
 </div>
 ...
 /* Empty State */
 <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-border-color dark:border-border-color p-12 text-center shadow-xs">
 <div className={clsx(
 "w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-sm",
 styles.bg,
 styles.text
 )}>
 {getIconComponent(department.icon)}
