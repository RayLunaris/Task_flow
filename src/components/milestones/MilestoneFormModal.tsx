          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary text-slate-800 dark:text-slate-100"
                required
                autoFocus
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-3 min-h-[80px] focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary text-slate-800 dark:text-slate-100"
              />
            </div>
