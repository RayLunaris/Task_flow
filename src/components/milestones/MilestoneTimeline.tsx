          ...
          return (
            ...
            >
              ...
              <div className={clsx(
                ...
                milestone.status === 'on_track' ? "bg-purple-500" : "bg-slate-300 dark:bg-slate-600"
              )} />
              ...
              <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm hover:shadow-md transition-shadow relative">
                ...
                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button onClick={() => onEdit(milestone)} className="text-slate-400 hover:text-purple-600 p-1">
                    <Edit2 size={16} />
                  </button>
                  <button 
                    onClick={() => {
                      if(confirm('Are you sure you want to delete this milestone?')) deleteMilestone(milestone.id);
                    }} 
                ...
                <div className="flex items-center gap-3 mb-2 pr-16">
                  ...
                  <span className={clsx(
                    ...
                    milestone.status === 'on_track' ? "bg-purple-50 text-purple-700 border-purple-200 dark:bg-purple-900/30 dark:border-purple-800 dark:text-purple-400" :
                ...
                <div className="flex items-center gap-2 text-sm font-medium text-slate-600 dark:text-slate-300 mb-4">
                  <Calendar size={16} className={isPastDue ? "text-pink-500" : "text-purple-500"} />
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <ProgressBar progress={progress} color={progress === 100 ? "bg-teal-500" : "bg-purple-500"} />
                </div>
              </div>
            </motion.div>
          );
