...
export const MilestoneTimeline: React.FC<MilestoneTimelineProps> = ({ milestones, onEdit }) => {
 ...
 <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-border-color dark:border-border-color p-5 shadow-sm hover:shadow-md transition-shadow relative">
 {/* Actions */}
 ...
 milestone.status === 'on_track' ? "bg-[#E3F2FD] text-[#0D47A1] border-[#90CAF9] dark:bg-blue-900/30 dark:border-blue-800 dark:text-primary" :
 ...
 <div className="pt-4 border-t border-slate-100 dark:border-border-color">
