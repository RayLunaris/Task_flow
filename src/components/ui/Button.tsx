...
export const Button: React.FC<ButtonProps> = ({
 ...
 secondary: 'bg-white text-slate-700 border border-border-color hover:bg-slate-50 shadow-none dark:bg-[#242424] dark:text-slate-200 dark:border-border-color dark:hover:bg-slate-700',
